...
const RecipeDetailsPage = async ({ params }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      <div className="relative h-72 sm:h-96 w-full rounded-3xl overflow-hidden mb-8 bg-gray-100 dark:bg-gray-800 shadow-lg">
        {recipe.recipeImage ? (
          <Image
        ...
        <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between flex-wrap gap-3">
          <div>
            <span className="inline-flex items-center gap-1.5 bg-white/90 dark:bg-gray-900/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-gray-800 dark:text-gray-100 mb-3">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4 mb-10">
        <div className="flex flex-wrap gap-3">
          <span className="inline-flex items-center gap-1.5 bg-orange-50 dark:bg-orange-950 text-orange-600 dark:text-orange-400 px-4 py-2 rounded-xl text-sm font-medium">
            {recipe.cuisineType} Cuisine
          </span>
          {recipe.preparationTime && (
            <span className="inline-flex items-center gap-1.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-xl text-sm font-medium">
          ...
          <div className="sm:col-span-2">
            ...
            <ul className="space-y-3">
              {recipe.ingredients.map((ing, i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-800 rounded-xl px-4 py-3"
                >
      ...
      <div className="mt-12 bg-gradient-to-r from-orange-50 to-rose-50 dark:from-gray-800 dark:to-gray-800 border border-orange-100 dark:border-gray-700 rounded-2xl p-6 flex items-center justify-between flex-wrap gap-4">
        <div>
