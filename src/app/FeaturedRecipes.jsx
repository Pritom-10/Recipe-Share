...
const FeaturedRecipes = async () => {
  ...
  if (!recipes || recipes.length === 0) {
    return null; // কোনো featured recipe না থাকলে সেকশনটাই দেখাবে না
  }
      ...
      <div className="flex gap-6 overflow-x-auto pb-4 -mx-4 px-4 snap-x snap-mandatory">
        {recipes.map((recipe) => (
          <Link
            ...
            className="group flex-shrink-0 w-72 snap-start rounded-2xl overflow-hidden bg-white shadow-md hover:shadow-2xl border border-gray-100 transition-all duration-300 hover:-translate-y-1.5"
          >
