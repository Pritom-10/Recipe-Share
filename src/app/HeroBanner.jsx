    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-orange-50 via-white to-rose-50">
      ...
      <div className="relative max-w-5xl mx-auto px-4 py-24 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 bg-white/70 backdrop-blur px-4 py-1.5 rounded-full text-sm font-medium text-orange-600 border border-orange-100 mb-6"
        >
        ...
        >
          <Link
            href="/recipes"
            className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-rose-500 text-white font-semibold px-8 py-4 rounded-2xl hover:shadow-xl hover:shadow-orange-200 transition-all"
          >
            Explore Recipes
